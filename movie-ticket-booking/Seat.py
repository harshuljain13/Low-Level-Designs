...
class SeatFactory:
    ...
    @staticmethod
    def create_seat(seat_type: SeatType, seat_id: str, seat_number: str, base_price: float) -> Seat:
        """
    ...
    @staticmethod
    def create_seat_row(seat_type: SeatType, row_number: int, seats_count: int, base_price: float) -> list[Seat]:
        """
