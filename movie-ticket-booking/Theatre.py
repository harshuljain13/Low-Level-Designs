...
class Theatre:
    ...
    def __init__(self, theatre_id: str, theatre_name: str, theatre_location: str,
                 theatre_address: str, theatre_contact: str, theatre_email: str):
        """
...
if __name__ == "__main__":
    theatre = Theatre("1", "Theatre 1", "Location 1", "Address 1", "Contact 1", "Email 1")
